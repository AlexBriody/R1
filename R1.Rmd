...
#### first_part \<- "Do you prefer python or R?"

second_part \<- "I think python rules!" full_part \<- paste(first_part, second_part) full_part sprintf("%s you prefer %s? %s", "Maybe", "javascript", second_part)Concatenating character objects
...
```{r}
first_part <- "Do you prefer python or R?"
second_part <- "I think python rules!"
full_part <- paste(first_part, second_part)
full_part
sprintf("%s you prefer %s? %s", "Maybe", "javascript", second_part)
```
...
# getting the first and third row as well as the first and third column
df[c(1,3),c(1,3)]
...
# Grab rows 2 to 3 of every matrix
my_array[2:3,,]

# Grab rows 1 and 3 of every matrix
my_array[c(1,3),,]
```
...
5.  Create two strings with your first and last name, respectively. Then concatenate them, and print the new value as "My name is \<your newly created concatenated variable will go here\>"
    ...
    last_name <- "Briody"
    concatenated_name <- paste(first_name, last_name)
    print(paste("My name is", concatenated_name))
    ```
